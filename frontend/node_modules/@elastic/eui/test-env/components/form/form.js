...
var _excluded = ["children", "className", "isInvalid", "error", "component", "invalidCallout"];
...
var EuiForm = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  return (0, _react2.jsx)(Element // @ts-expect-error Element is a <div> or <form>, but TypeScript wants to support both
  , (0, _extends2.default)({
    ref: ref,
    className: classes
