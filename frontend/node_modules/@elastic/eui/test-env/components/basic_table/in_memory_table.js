  ...
  function EuiInMemoryTable(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onTableChange", function (_ref4) {
      ...
      var _ref5 = page || {},
          ...
          pageSize = _ref5.size; // don't apply pagination changes that are otherwise controlled
      ...
      var _ref6 = sort || {},
          ...
          sortDirection = _ref6.direction; // To keep backwards compatibility reportedSortName needs to be tracked separately
      // from sortName; sortName gets stored internally while reportedSortName is sent to the callback


      var reportedSortName = sortName; // EuiBasicTable returns the column's `field` instead of `name` on sort
      ...
      if (sortName) {
        ...
        if (sortColumn) {
          ...
          sortName = sortColumn.name; // Ensure reportedSortName uses `field` if it exists
