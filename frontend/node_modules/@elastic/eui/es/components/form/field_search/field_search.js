...
export var EuiFieldSearch = /*#__PURE__*/function (_Component) {
  ...
  _createClass(EuiFieldSearch, [{
    ...
    value: function render() {
      ...
      if (typeof this.props.value !== 'string') value = this.state.value; // Set actual value of isClearable if value exists as well
      ...
      var classes = classNames('euiFieldSearch', numIconsClass, {
