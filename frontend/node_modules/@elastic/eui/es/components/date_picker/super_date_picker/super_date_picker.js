...
}(Component); // Because EuiSuperDatePicker is a class component and not a functional component,
...
EuiSuperDatePickerInternal.propTypes = {
  ...
  isDisabled: PropTypes.oneOfType([PropTypes.bool, PropTypes.bool.isRequired]),
