...
var EuiCard = function EuiCard(_ref) {
  ...
  if (betaBadgeProps !== null && betaBadgeProps !== void 0 && betaBadgeProps.label) {
    ...
    }, (0, _react2.jsx)(_beta_badge.EuiBetaBadge, _extends({
  ...
  if (selectable) {
    optionalSelectButton = (0, _react2.jsx)(_card_select.EuiCardSelect, _extends({
...
EuiCard.propTypes = {
  ...
  /**
       ...
       */
  betaBadgeProps: _propTypes.default.any,
